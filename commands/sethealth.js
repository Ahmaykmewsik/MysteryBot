...
module.exports = {
	...
	execute(client, message, args) {
        ...
        if (players == undefined) {
            return message.channel.send("You don't have any players. There's no one to set the health of!");
        }
        ...
        playerToMove.health = healthValue;
        ...
        message.channel.send("Health of " + playerToMove.name + " set to `" + healthValue + "`");
